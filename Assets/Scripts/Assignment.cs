...
public class Assignment : MonoBehaviour
{
    ...
    public void As06_Calculate()
    {
        ...
        string formattedResult = (result % 1 == 0) ? result.ToString("F0") : result.ToString("G15");
        Debug.Log($"Result: {formattedResult}");
    }
    ...
    public void As10_CalculateWeaponDamage()
    {
        ...
        string weaponType = as10WeaponType != null ? as10WeaponType.ToLower() : "";
